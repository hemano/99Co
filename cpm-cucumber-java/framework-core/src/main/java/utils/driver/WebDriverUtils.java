...
//    public static void scrollTop(WebDriver driver, final PageObject.ScrollSpeedMode mode )
//    {
//        JavaScriptHelper js = JavaScriptHelper.withDriver( driver );
//        js.executeScript( "$('html, body').animate({ scrollTop: 0 }, '" + mode.name().toLowerCase() + "');" );
